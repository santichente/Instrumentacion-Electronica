...
/////////////////////////
float volumenDeseado = 200; //en mL
//////////////////////////
...
void onoff() {
  ...
  if (fin == false) {
    ...
    if (volumenDeseado < 100) {
      Var = 512;
      lim_prop4 = volumenDeseado * 0.90;
      if(volumenDeseado < 25){
        lim_prop4 = volumenDeseado * 0.80;
      Var=250;
      }      
    }
    if (volumenDeseado >= 100) {
    ...
    if(volumenDeseado < 300 &&  volumenDeseado > 100){
       lim_prop4 = volumenDeseado*0.931;
    }
    if (volumen >= lim_prop3) {
      Var = Var - 20;
    }
    if (volumenDeseado >= 600){
    lim_prop4 = volumenDeseado*0.985;
    }
